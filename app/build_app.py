...
body{margin:0;background:var(--bg);color:var(--ink);font-family:"Microsoft YaHei","PingFang SC",system-ui,sans-serif;line-height:1.6;-webkit-font-smoothing:antialiased;overflow-x:hidden}
...
.up-hero{padding:24px 0 8px}
.up-hero h1{font-size:22px;line-height:1.35}
.up-hero p{font-size:14px;padding:0 2px}
.up-hero .logo{font-size:16px}
