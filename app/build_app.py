...
.imgzone .thumb-strip{margin-top:10px;padding:8px;border-radius:10px;background:rgba(46,117,182,.05);border:1px solid rgba(46,117,182,.12);width:100%}
.imgzone .thumbs{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;width:100%;align-items:start}
.thumb{position:relative;width:100%;aspect-ratio:1;border-radius:8px;overflow:hidden;border:1px solid var(--line);background:#fff}
.thumb img{width:100%;height:100%;object-fit:cover;display:block}
.thumb .idx{position:absolute;left:3px;bottom:3px;min-width:16px;height:16px;padding:0 4px;border-radius:6px;background:rgba(31,78,121,.78);color:#fff;font-size:10px;font-weight:700;line-height:16px;text-align:center;z-index:1}
