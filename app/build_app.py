...
CSS = """
:root{--bg:#f5f7fb;--card:#fff;--ink:#1f2733;--mut:#7a8699;--line:#e6ebf2;--pos:#178a5a;--neg:#d83a3a;--warn:#d98a00;--accent:#1f4e79;--accent2:#2e75b6;}
...
.zone.ok{border-style:solid;border-color:var(--pos);background:#f3fbf6}
.zone .ic{font-size:30px}
.zone .ttl{font-weight:700;margin:8px 0 4px;font-size:15px}
.zone .hint{color:var(--mut);font-size:12.5px}
.zone .fname{margin-top:8px;color:var(--pos);font-size:13px;font-weight:600;word-break:break-all}
.req{color:var(--neg);font-size:11px}.opt{color:var(--mut);font-size:11px}
...
.err{color:var(--neg);text-align:center;margin-top:14px;font-size:14px;min-height:20px}
...
.problem.sev-critical{border-left-color:var(--neg)}.problem.sev-high{border-left-color:var(--warn)}.problem.sev-medium{border-left-color:var(--accent2)}
...
.sev.sev-critical{background:var(--neg)}.sev.sev-high{background:var(--warn)}.sev.sev-medium{background:var(--accent2)}
...
.ai-tag .real{background:var(--pos);color:#fff;border-radius:10px;padding:1px 8px;font-size:11px;margin-left:6px}
...
print("TradeCheck.html bytes:",len(html))
