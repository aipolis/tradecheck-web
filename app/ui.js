...
function unlockReportScroll(){
  ...
  [html,body].forEach(el=>{el.style.cssText="height:auto!important;min-height:0!important;max-height:none!important;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch"});
  if(rep){
    rep.style.cssText="display:block!important;height:auto!important;min-height:0!important;max-height:none!important;overflow:visible!important;position:relative";
  }
}
